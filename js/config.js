...
export const translations = {
  en: {
    ...
    roomSelectionIntro: "What type of room are you interested in? Tell me about your preferences — number of guests, view, floor, or other special requirements.",
    serviceSelectionIntro: "What service are you interested in? Write to me, and I will help you place an order.",
    roomSelectedOfferServices: "Excellent! You selected \"{roomName}\". I can suggest additional services for your comfort:",
    roomsLeftLabel: "Left: {count}",
    sqm: "m²",
    noName: "Untitled",
    roomsUnavailable: "Unfortunately, there are no rooms available at the moment.",
    servicesUnavailable: "Unfortunately, there are no services available at the moment.",
    roomsDescriptionHeader: "🏨 **Our rooms:**",
    servicesDescriptionHeader: "🛍️ **Our services:**",
    differentRoom: "Different room",
    price: "Price",
    anythingElse: "Is there anything else I can help you with?",
    noDescription: "No description available.",
    serviceAddMsg_user: "I want to add this to my booking: {serviceName}",
    serviceAddMsg_ai: "Excellent! The service \"{serviceName}\" has been added to your booking. Is there anything else you are interested in?",
    serviceAskMsg_user: "I have a question about the service: {serviceName}",
    bookingIntentMsg_user: "I want to book room \"{roomName}\" ({price}/night)",
  ...
  ru: {
    ...
    roomSelectionIntro: "Какой тип номера вас интересует? Расскажите о ваших пожеланиях — количество гостей, вид из окна, этаж или другие особые требования.",
    serviceSelectionIntro: "Какая услуга вас интересует? Напишите мне, и я помогу оформить заказ.",
    roomSelectedOfferServices: "Отлично! Вы выбрали \"{roomName}\". Могу предложить дополнительные услуги для вашего комфорта:",
    roomsLeftLabel: "Осталось: {count}",
    sqm: "м²",
    noName: "Без названия",
    roomsUnavailable: "К сожалению, на данный момент нет доступных номеров.",
    servicesUnavailable: "К сожалению, на данный момент нет доступных услуг.",
    roomsDescriptionHeader: "🏨 ** Наши номера:**",
    servicesDescriptionHeader: "🛍️ **Наши услуги:**",
    differentRoom: "Другой номер",
    price: "Цена",
    anythingElse: "Чем еще я могу вам помочь?",
    noDescription: "Описание отсутствует.",
    serviceAddMsg_user: "Хочу добавить к бронированию: {serviceName}",
    serviceAddMsg_ai: "Отлично! Услуга \"{serviceName}\" добавлена к вашему бронированию. Есть еще что-то, что вас интересует?",
    serviceAskMsg_user: "У меня вопрос по услуге: {serviceName}",
    bookingIntentMsg_user: "Хочу забронировать номер \"{roomName}\" ({price}/ночь)",
    applyToAllHotels: "Применить для всех отелей"
  },
  id: {
  ...
  uk: {
    ...
    ourRooms: "Наші номери",
    ourServices: "Наші послуги",
    roomSelectionIntro: "Який тип номера вас цікавить? Розкажіть про ваші побажання — кількість гостей, вид з вікна, поверх чи інші особливі вимоги.",
    serviceSelectionIntro: "Яка послуга вас цікавить? Напишіть мені, і я допоможу оформити замовлення.",
    roomSelectedOfferServices: "Чудово! Ви обрали \"{roomName}\". Можу запропонувати додаткові послуги для вашого комфорту:",
    roomsLeftLabel: "Залишилось: {count}",
    sqm: "м²",
    noName: "Без назви",
    roomsUnavailable: "На жаль, наразі немає доступних номерів.",
    servicesUnavailable: "На жаль, наразі немає доступних послуг.",
    roomsDescriptionHeader: "🏨 **Наші номери:**",
    servicesDescriptionHeader: "🛍️ **Наші послуги:**",
    differentRoom: "Інший номер",
    price: "Ціна",
    anythingElse: "Чим ще можу допомогти?",
    noDescription: "Опис відсутній.",
    serviceAddMsg_user: "Хочу додати до бронювання: {serviceName}",
    serviceAddMsg_ai: "Чудово! Послугу \"{serviceName}\" додано до вашого бронювання. Є ще щось, що вас цікавить?",
    serviceAskMsg_user: "Маю питання про послугу: {serviceName}",
    bookingIntentMsg_user: "Хочу забронювати номер \"{roomName}\" ({price}/ніч)",
    applyToAllHotels: "Застосувати для всіх готелів"
  },
  de: {
